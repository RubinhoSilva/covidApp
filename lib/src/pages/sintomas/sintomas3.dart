import 'package:covid/src/pages/sintomas/sintomas4.dart';
...
class Sintomas3Screen extends StatefulWidget {
  final double peso;
  final int qtdSintomas;

  Sintomas3Screen({Key key, this.peso, this.qtdSintomas}) : super(key: key);

  @override
  _Sintomas3ScreenState createState() => _Sintomas3ScreenState(peso, qtdSintomas);
}
class _Sintomas3ScreenState extends State<Sintomas3Screen> {
  double _peso;
  int _qtdSintomas;
  bool _radioSintomas;
  _Sintomas3ScreenState(this._peso, this._qtdSintomas);
        ...
        children: <Widget>[
          new Row(
            ...
            children: <Widget>[
              ...
              new Text(
                "Apresentou perda do olfato nos ultimos dias?",
