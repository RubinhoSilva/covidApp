...
class Sintomas5Screen extends StatefulWidget {
  final double peso;
  final int qtdSintomas;

  Sintomas5Screen({Key key, this.peso, this.qtdSintomas}) : super(key: key);

  @override
  _Sintomas5ScreenState createState() =>
      _Sintomas5ScreenState(peso, qtdSintomas);
}

class _Sintomas5ScreenState extends State<Sintomas5Screen> {
  double _peso;
  int _qtdSintomas;
  bool _radioSintomas;

  _Sintomas5ScreenState(this._peso, this._qtdSintomas);
  ...
  void calcularPeso() {
    ...
    if (_peso / _qtdSintomas >= 1) {
      Toast.show("Voce esta sendo incluido como suspeito no app!", context,
